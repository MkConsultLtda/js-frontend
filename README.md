...
- Login real com **cookies HttpOnly** via rotas `app/api/auth/*` (ver `docs/implementacao/auth-cookies-httponly-2026-04-26.md`).
- **middleware** (`middleware.ts`) redireciona rotas protegidas sem cookie de access.
